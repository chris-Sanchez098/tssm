...
public class UserTest {
    ...
    public void init(){
        ...
        user2 = new User(1193075514, "Victor Sapuyes", "neveu", "neveu","gerente", true);
    }
    ...
    public void pwdTests(){
        assertAll("several pwd",
                ...
                () -> assertTrue(user.pwdEqual("Victor123@")),
                () -> assertFalse(user.pwdEqual("pws12131")),
                () -> assertFalse(user.pwdEqualUser()),
                () -> assertTrue(user2.pwdEqualUser())
        );
    }
}
